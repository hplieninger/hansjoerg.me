...
date: '2018-02-01'
description: "Personal website and blog of Hansjörg Plieninger covering R, data science, psychology, and the like."
---
...
var username = "plieninger";
var hostname = "uni-mannheim.de";
var linktext = username + "@" + hostname ;
document.write("<p>You can contact me via <a href='" + "mail" + "to:" + username + "@" + hostname + "'>" + linktext + "</a>.</p>");
</script>
