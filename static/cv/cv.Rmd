...
- **Wrangling**: Bringing raw data into a format suitable for subsequent analyses ([example](https://github.com/hplieninger/hansjoerg.me/tree/master/static/uploads/handball-data.md))
